      ...
      Column(
        children: [
          Stack(
            children: [
              ...
              Padding(
                ...
                child:
                Text("Crown Plaza,Kochi",style: Theme.of(context).textTheme.displayLarge),),Padding(
                ...
                Container(
                    ...
                    child: Center(child: Text("  9/10 Reviews  ",style: Theme.of(context).textTheme.headlineSmall))),),
              Padding(
          ...
          Padding(
            ...
            child: Text("Crown Plaza,Kochi" , style: Theme.of(context).textTheme.displayMedium),
          ),
          Padding(
